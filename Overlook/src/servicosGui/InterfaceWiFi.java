...
public class InterfaceWiFi extends JFrame {
	...
	public InterfaceWiFi() {
		...
		btnServicos.setIcon(new ImageIcon(InterfaceWiFi.class.getResource("/interfaces/imagens/Botao servicos 65x23.png")));
		...
		btnFecharTela.setIcon(new ImageIcon(InterfaceWiFi.class.getResource("/interfaces/imagens/Botao Fechar quadrado 30x30.png")));
		...
		btnSignOut.setIcon(new ImageIcon(InterfaceWiFi.class.getResource("/interfaces/imagens/Botao sign out 30x30.png")));
		btnSignOut.setBounds(1213, 0, 30, 30);
		contentPane.add(btnSignOut);
		
		JLabel lblLogoTelas = new JLabel("");
		lblLogoTelas.setIcon(new ImageIcon(InterfaceWiFi.class.getResource("/interfaces/imagens/logo telas 480x320.png")));
		lblLogoTelas.setBounds(750, 219, 480, 320);
		contentPane.add(lblLogoTelas);
		
		JLabel lblLogoTransparente = new JLabel("");
		lblLogoTransparente.setIcon(new ImageIcon(InterfaceWiFi.class.getResource("/interfaces/imagens/icone logo transparente 758x758.png")));
