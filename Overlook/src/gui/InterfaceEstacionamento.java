...
public class InterfaceEstacionamento extends JFrame {
	...
	public InterfaceEstacionamento() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(InterfaceEstacionamento.class.getResource("/interfaces/imagens/iconeOverlook.png")));
		...
		lblLogoTelas.setIcon(
				new ImageIcon(InterfaceEstacionamento.class.getResource("/interfaces/imagens/logo telas 480x320.png")));
		...
		btnNewButton.setIcon(new ImageIcon(
				InterfaceEstacionamento.class.getResource("/interfaces/imagens/Botao servicos 65x23.png")));
		...
		lblLogoTransparente.setIcon(new ImageIcon(
				InterfaceEstacionamento.class.getResource("/interfaces/imagens/icone logo transparente 758x758.png")));
		...
		btnFecharTela.setIcon(new ImageIcon(
				InterfaceEstacionamento.class.getResource("/interfaces/imagens/Botao Fechar quadrado 30x30.png")));
		...
		btnSignOut.setIcon(new ImageIcon(
				InterfaceEstacionamento.class.getResource("/interfaces/imagens/Botao sign out 30x30.png")));
