...
public class InterfaceReservas {
	...
	private TableModel modeloReservas() {
		...
		try {
			...
			for (Reserva p : leitor.leituraReservas()) {
				tableModel.addRow(new Object[] { p.getIdReserva(), p.getCPF(), p.getDataEntrada(), p.getDataSaida(),
						p.getObservacaoReserva(), p.getNumeroQuarto() });
			}
	...
	private void initialize() {
		...
		frmCadastroDasReservas.setIconImage(Toolkit.getDefaultToolkit()
				.getImage(InterfaceReservas.class.getResource("/interfaces/imagens/iconeOverlook.png")));
		...
		table = new JTable();
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Id Reserva", "CPF", "Data Entrada",
				"Data sa\u00EDda", "Observa\u00E7\u00E3o", "N\u00FAmero Quarto" }));
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					controlador.registroReserva(inteiroQuarto, ftxtCpf.getText(), dataEntrada, dataSaida,
		...
		lblNewLabel.setIcon(new ImageIcon(
				InterfaceReservas.class.getResource("/interfaces/imagens/icone logo transparente 758x758.png")));
		...
		btnFecharTela.setIcon(new ImageIcon(
				InterfaceReservas.class.getResource("/interfaces/imagens/Botao Fechar quadrado 30x30.png")));
		...
		btnSignOut.setIcon(
				new ImageIcon(InterfaceReservas.class.getResource("/interfaces/imagens/Botao sign out 30x30.png")));
		btnSignOut.setBounds(1213, 0, 30, 30);
		frmCadastroDasReservas.getContentPane().add(btnSignOut);

		JLabel lblLogoPequena = new JLabel("");
		lblLogoPequena
				.setIcon(new ImageIcon(InterfaceReservas.class.getResource("/interfaces/imagens/logo 220 x150.png")));
